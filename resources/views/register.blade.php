               ...
               <!--
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1"> <!--md:grid-cols-2-->
                        ...
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Register
                        <hr>
                        <div class="p-6">
                            <div class="ml-12">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12">
                             <div class="form-group mb-3">
                                <label for="confirm_email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm Email</label>
                                <input type="text" placeholder="confirm_email" id="confirm_email" class="form-control" name="confirm_email" required>
                                @if ($errors->has('confirm_email'))
                                <span class="text-danger">{{ $errors->first('confirm_email') }}</span>
                                @endif
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12">
                             <div class="form-group mb-3">
                                <label for="organize" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Organize</label>
                                <input type="text" placeholder="organize" id="organize" class="form-control" name="organize" required>
                                @if ($errors->has('organize'))
                                <span class="text-danger">{{ $errors->first('organize') }}</span>
                                @endif
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12">
                             <div class="form-group mb-3">
                                <label for="pic" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Picture</label>
                                <input type="file" id="picture" class="form-control" name="pic" required>
                                @if ($errors->has('picture'))
                                <span class="text-danger">{{ $errors->first('picture') }}</span>
                                @endif
                             </div>
